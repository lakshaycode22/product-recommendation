...
const tdata = {
    "products": [
        ...
        },
        {
            ...
            "specific_category": "Ethnic Wear",
            "image": "[\"http://img5a.flixcart.com/image/kurti/h/y/z/1-1-e17-gee-bee-l-original-imaeazcgxh7fbsce.jpeg\", \"http://img6a.flixcart.com/image/kurti/h/y/z/1-1-e17-gee-bee-l-original-imaeazcgtj7vzt5h.jpeg\", \"http://img5a.flixcart.com/image/kurti/h/y/z/1-1-e17-gee-bee-l-original-imaeazcjz4n82ycx.jpeg\"]",
            "product_rating": null,
            "product_name": "Gee & Bee Casual Printed Women's Kurti",
            "description": "Gee & Bee Casual Printed Women's Kurti\n                         Price: Rs. 649\n\t\t\t\t\n\t\t\tGee & Bee Presents 100% cotton Womens Kurtis with premium qality fabric and in ozone free dyes\nGee & Bee Presents 100% cotton Womens Kurtis with premium qality fabric and in ozone free dyes",
            "overall_rating": null,
            ...
            "product_url": "http://www.flipkart.com/gee-bee-casual-printed-women-s-kurti/p/itmebfrqbywzqzxz?pid=KRTEBFRQVB9NCSSH",
            "product_specifications": "{\"product_specification\"=>[{\"value\"=>\"1 Kurti\"}, {\"key\"=>\"Sleeve\", \"value\"=>\"Sleeveless\"}, {\"key\"=>\"Number of Contents in Sales Package\", \"value\"=>\"Pack of 1\"}, {\"key\"=>\"Region\", \"value\"=>\"Kolkata\"}, {\"key\"=>\"Fabric\", \"value\"=>\"Cotton\"}, {\"key\"=>\"Type\", \"value\"=>\"A-line\"}, {\"key\"=>\"Neck\", \"value\"=>\"Round Neck\"}, {\"key\"=>\"Pattern\", \"value\"=>\"Printed\"}, {\"key\"=>\"Occasion\", \"value\"=>\"Casual\"}, {\"key\"=>\"Ideal For\", \"value\"=>\"Women's\"}, {\"value\"=>\"Wash with Similar Colors\"}]}",
            "retail_price": 2164,
            "top_level_category": "Clothing",
        ...
        {
            "crawl_timestamp": "2016-03-25 15:39:25 +0000",
            "product_url": "http://www.flipkart.com/sohardhastshilp-self-design-women-s-lehenga-choli-dupatta-set/p/itmegxzzjxwmmurq?pid=LCHEGYYBWP4ECBZJ",
            "economic_status": "Rich",
            "product_rating": null,
            "product_name": "Sohardhastshilp Self Design Women's Lehenga, Choli and Dupatta Set",
            ...
            "is_FK_Advantage_product": false,
            "description": "Key Features of Sohardhastshilp Self Design Women's Lehenga, Choli and Dupatta Set Lehenga Fabric: Synthetic Brand Color: Blue, Pink,Specifications of Sohardhastshilp Self Design Women's Lehenga, Choli and Dupatta Set Lehenga Choli Details Lehenga Fabric Synthetic Type Lehenga, Choli and Dupatta Set General Details Pattern Self Design Ideal For Women's In the Box 1 Lehenga, 1 Choli, 1 Dupatta Set",
            "specific_category": "Ethnic Wear",
            "product_category_tree": "[\"Clothing >> Women's Clothing >> Ethnic Wear >> Lehenga Cholis >> Lehenga Cholis >> Sohardhastshilp Lehenga Cholis >> Sohardhastshilp Self Design Women's Lehenga, Cho...\"]",
            "top_level_category": "Clothing",
            "product_specifications": "{\"product_specification\"=>[{\"key\"=>\"Lehenga Fabric\", \"value\"=>\"Synthetic\"}, {\"key\"=>\"Type\", \"value\"=>\"Lehenga, Choli and Dupatta Set\"}, {\"key\"=>\"Pattern\", \"value\"=>\"Self Design\"}, {\"key\"=>\"Ideal For\", \"value\"=>\"Women's\"}, {\"value\"=>\"1 Lehenga, 1 Choli, 1 Dupatta Set\"}]}",
            "retail_price": 2000,
            "overall_rating": null,
